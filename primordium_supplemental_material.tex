...
\begin{Highlighting}[]
\NormalTok{size\_vec =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{, }\DecValTok{32}\NormalTok{, }\DecValTok{64}\NormalTok{, }\DecValTok{128}\NormalTok{, }\DecValTok{256}\NormalTok{, }\DecValTok{512}\NormalTok{)}
\NormalTok{num\_samples =}\StringTok{ }\DecValTok{3000}
\NormalTok{num\_batches =}\StringTok{ }\DecValTok{30} 
\NormalTok{batch\_size =}\StringTok{ }\NormalTok{num\_samples }\OperatorTok{/}\StringTok{ }\NormalTok{num\_batches}
\NormalTok{max\_gen =}\StringTok{ }\DecValTok{10000}

\CommentTok{\# Load data}
\NormalTok{df\_finite =}\StringTok{ }\OtherTok{NA}
\ControlFlowTok{for}\NormalTok{(size }\ControlFlowTok{in}\NormalTok{ size\_vec)\{}
  \ControlFlowTok{for}\NormalTok{(batch\_id }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{num\_batches)\{}
    \ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.data.frame}\NormalTok{(df\_finite))\{}
\NormalTok{      df\_finite =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}../experiments/2021\_03\_07\_\_inf\_population/simulation/data/size\_\textquotesingle{}}\NormalTok{, size, }\StringTok{\textquotesingle{}\_\_batch\_\textquotesingle{}}\NormalTok{, batch\_id, }\StringTok{\textquotesingle{}.csv\textquotesingle{}}\NormalTok{))}
\NormalTok{      df\_finite}\OperatorTok{$}\NormalTok{batch\_id =}\StringTok{ }\NormalTok{batch\_id}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{\{}
\NormalTok{      df\_finite\_tmp =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}../experiments/2021\_03\_07\_\_inf\_population/simulation/data/size\_\textquotesingle{}}\NormalTok{, size, }\StringTok{\textquotesingle{}\_\_batch\_\textquotesingle{}}\NormalTok{, batch\_id, }\StringTok{\textquotesingle{}.csv\textquotesingle{}}\NormalTok{))}
\NormalTok{      df\_finite\_tmp}\OperatorTok{$}\NormalTok{batch\_id =}\StringTok{ }\NormalTok{batch\_id}
\NormalTok{      df\_finite =}\StringTok{ }\KeywordTok{rbind}\NormalTok{(df\_finite, df\_finite\_tmp)}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}

\CommentTok{\# Summarize data, grabbing the mean from the simulation}
\NormalTok{df\_finite\_summary =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{4}\NormalTok{))}
\KeywordTok{colnames}\NormalTok{(df\_finite\_summary) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}mc\_size\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}generation\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}mean\_ones\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}batch\_id\textquotesingle{}}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{(size }\ControlFlowTok{in}\NormalTok{ size\_vec)\{}
\NormalTok{  size\_mask =}\StringTok{ }\NormalTok{df\_finite}\OperatorTok{$}\NormalTok{mc\_size }\OperatorTok{==}\StringTok{ }\NormalTok{size}
  \ControlFlowTok{for}\NormalTok{(batch\_id }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(df\_finite}\OperatorTok{$}\NormalTok{batch\_id))\{}
\NormalTok{    mask =}\StringTok{ }\NormalTok{size\_mask }\OperatorTok{\&}\StringTok{ }\NormalTok{df\_finite}\OperatorTok{$}\NormalTok{batch\_id }\OperatorTok{==}\StringTok{ }\NormalTok{batch\_id}
    \ControlFlowTok{for}\NormalTok{(gen }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(df\_finite}\OperatorTok{$}\NormalTok{generation))\{}
\NormalTok{      df\_finite\_summary[}\KeywordTok{nrow}\NormalTok{(df\_finite\_summary) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{,] =}\StringTok{ }\KeywordTok{c}\NormalTok{(size, gen, }\KeywordTok{weighted.mean}\NormalTok{(}\DecValTok{0}\OperatorTok{:}\DecValTok{100}\NormalTok{, df\_finite[mask }\OperatorTok{\&}\StringTok{ }\NormalTok{df\_finite}\OperatorTok{$}\NormalTok{generation }\OperatorTok{==}\StringTok{ }\NormalTok{gen,]}\OperatorTok{$}\NormalTok{frac\_of\_pop), batch\_id)}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}

\CommentTok{\# Trim to final generation}
\NormalTok{df\_finite\_summary =}\StringTok{ }\NormalTok{df\_finite\_summary[df\_finite\_summary}\OperatorTok{$}\NormalTok{generation }\OperatorTok{==}\StringTok{ }\NormalTok{max\_gen,]}
\CommentTok{\# Rename column}
\NormalTok{df\_finite\_summary}\OperatorTok{$}\NormalTok{restraint\_value =}\StringTok{ }\NormalTok{df\_finite\_summary}\OperatorTok{$}\NormalTok{mean\_ones }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  res =}\StringTok{ }\KeywordTok{kruskal.test}\NormalTok{(df\_finite\_summary}\OperatorTok{$}\NormalTok{restraint\_value }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{df\_finite\_summary}\OperatorTok{$}\NormalTok{mc\_size, df\_finite\_summary)}
\NormalTok{  df\_kruskal =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{3}\NormalTok{))}
  \KeywordTok{colnames}\NormalTok{(df\_kruskal) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}p\_value\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}chi\_squared\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}df\textquotesingle{}}\NormalTok{)}
\NormalTok{  df\_kruskal[}\KeywordTok{nrow}\NormalTok{(df\_kruskal) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{,] =}\StringTok{ }\KeywordTok{c}\NormalTok{(res}\OperatorTok{$}\NormalTok{p.value, }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{statistic)[}\DecValTok{1}\NormalTok{], }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{parameter)[}\DecValTok{1}\NormalTok{])}
\NormalTok{  df\_kruskal}\OperatorTok{$}\NormalTok{less\_}\FloatTok{0.01}\NormalTok{ =}\StringTok{ }\NormalTok{df\_kruskal}\OperatorTok{$}\NormalTok{p\_value }\OperatorTok{\textless{}}\StringTok{ }\FloatTok{0.01}
...
\begin{verbatim}
##        p_value chi_squared df less_0.01
## 1 6.864684e-27    132.5438  5      TRUE
\end{verbatim}
...
\NormalTok{df\_finite\_wilcox =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{5}\NormalTok{))}
\NormalTok{adjacent\_counter =}\StringTok{ }\DecValTok{0}
\KeywordTok{colnames}\NormalTok{(df\_finite\_wilcox) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}size\_a\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}size\_b\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}p\_value\_corrected\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}p\_value\_raw\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}W\textquotesingle{}}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{(size\_idx\_a }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{(}\KeywordTok{length}\NormalTok{(size\_vec) }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{))\{}
\NormalTok{  size\_a =}\StringTok{ }\NormalTok{size\_vec[size\_idx\_a]}
\NormalTok{  size\_a\_str =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(size\_a, }\StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{, size\_a)}
  \ControlFlowTok{for}\NormalTok{(size\_idx\_b }\ControlFlowTok{in}\NormalTok{ (size\_idx\_a }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{)}\OperatorTok{:}\KeywordTok{length}\NormalTok{(size\_vec))\{}
\NormalTok{    size\_b =}\StringTok{ }\NormalTok{size\_vec[size\_idx\_b]}
\NormalTok{    size\_b\_str =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(size\_b, }\StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{, size\_b)}
\NormalTok{    res =}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(}
\NormalTok{      df\_finite\_summary[df\_finite\_summary}\OperatorTok{$}\NormalTok{mc\_size }\OperatorTok{==}\StringTok{ }\NormalTok{size\_a,]}\OperatorTok{$}\NormalTok{restraint\_value, }
\NormalTok{      df\_finite\_summary[df\_finite\_summary}\OperatorTok{$}\NormalTok{mc\_size }\OperatorTok{==}\StringTok{ }\NormalTok{size\_b,]}\OperatorTok{$}\NormalTok{restraint\_value, }
      \DataTypeTok{alternative =} \StringTok{\textquotesingle{}two.sided\textquotesingle{}}\NormalTok{) }
\NormalTok{    df\_finite\_wilcox[}\KeywordTok{nrow}\NormalTok{(df\_finite\_wilcox) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{,] =}\StringTok{ }\KeywordTok{c}\NormalTok{(size\_a\_str, size\_b\_str, }\DecValTok{0}\NormalTok{, res}\OperatorTok{$}\NormalTok{p.value, }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{statistic)[}\DecValTok{1}\NormalTok{])}
\NormalTok{  \}}
\NormalTok{\}}
\NormalTok{df\_finite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected =}\StringTok{ }\KeywordTok{p.adjust}\NormalTok{(df\_finite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_raw, }\DataTypeTok{method =} \StringTok{\textquotesingle{}holm\textquotesingle{}}\NormalTok{)}
\NormalTok{df\_finite\_wilcox}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}ns\textquotesingle{}}
\NormalTok{df\_finite\_wilcox[df\_finite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected }\OperatorTok{\textless{}=}\StringTok{ }\FloatTok{0.05}\NormalTok{,]}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}*\textquotesingle{}}
\NormalTok{df\_finite\_wilcox[df\_finite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected }\OperatorTok{\textless{}=}\StringTok{ }\FloatTok{0.01}\NormalTok{,]}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}**\textquotesingle{}}
\NormalTok{df\_finite\_wilcox[df\_finite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected }\OperatorTok{\textless{}=}\StringTok{ }\FloatTok{0.001}\NormalTok{,]}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}***\textquotesingle{}}
\KeywordTok{print}\NormalTok{(df\_finite\_wilcox)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Load data}
\NormalTok{df\_infinite =}\StringTok{ }\OtherTok{NA}
\ControlFlowTok{for}\NormalTok{(size }\ControlFlowTok{in}\NormalTok{ size\_vec)\{}
  \ControlFlowTok{for}\NormalTok{(batch\_id }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{num\_batches)\{}
    \ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.data.frame}\NormalTok{(df\_infinite))\{}
\NormalTok{      df\_infinite =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}../experiments/2021\_03\_08\_\_inf\_genome\_inf\_pop/simulation/data/size\_\textquotesingle{}}\NormalTok{, size, }\StringTok{\textquotesingle{}\_\_batch\_\textquotesingle{}}\NormalTok{, batch\_id, }\StringTok{\textquotesingle{}.csv\textquotesingle{}}\NormalTok{))}
\NormalTok{      df\_infinite}\OperatorTok{$}\NormalTok{batch\_id =}\StringTok{ }\NormalTok{batch\_id}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{\{}
\NormalTok{      df\_infinite\_tmp =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}../experiments/2021\_03\_08\_\_inf\_genome\_inf\_pop/simulation/data/size\_\textquotesingle{}}\NormalTok{, size, }\StringTok{\textquotesingle{}\_\_batch\_\textquotesingle{}}\NormalTok{, batch\_id, }\StringTok{\textquotesingle{}.csv\textquotesingle{}}\NormalTok{))}
\NormalTok{      df\_infinite\_tmp}\OperatorTok{$}\NormalTok{batch\_id =}\StringTok{ }\NormalTok{batch\_id}
\NormalTok{      df\_infinite =}\StringTok{ }\KeywordTok{rbind}\NormalTok{(df\_infinite, df\_infinite\_tmp)}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}

\CommentTok{\# Summarize data, grabbing the mean from the simulation}
\NormalTok{df\_infinite\_summary =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{4}\NormalTok{))}
\KeywordTok{colnames}\NormalTok{(df\_infinite\_summary) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}mc\_size\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}generation\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}mean\_ones\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}batch\_id\textquotesingle{}}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{(size }\ControlFlowTok{in}\NormalTok{ size\_vec)\{}
\NormalTok{  size\_mask =}\StringTok{ }\NormalTok{df\_infinite}\OperatorTok{$}\NormalTok{mc\_size }\OperatorTok{==}\StringTok{ }\NormalTok{size}
  \ControlFlowTok{for}\NormalTok{(batch\_id }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(df\_infinite}\OperatorTok{$}\NormalTok{batch\_id))\{}
\NormalTok{    mask =}\StringTok{ }\NormalTok{size\_mask }\OperatorTok{\&}\StringTok{ }\NormalTok{df\_infinite}\OperatorTok{$}\NormalTok{batch\_id }\OperatorTok{==}\StringTok{ }\NormalTok{batch\_id}
    \ControlFlowTok{for}\NormalTok{(gen }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(df\_infinite}\OperatorTok{$}\NormalTok{generation))\{}
\NormalTok{      df\_infinite\_summary[}\KeywordTok{nrow}\NormalTok{(df\_infinite\_summary) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{,] =}\StringTok{ }\KeywordTok{c}\NormalTok{(size, gen, }\KeywordTok{weighted.mean}\NormalTok{(}\OperatorTok{{-}}\DecValTok{100}\OperatorTok{:}\DecValTok{550}\NormalTok{, df\_infinite[mask }\OperatorTok{\&}\StringTok{ }\NormalTok{df\_infinite}\OperatorTok{$}\NormalTok{generation }\OperatorTok{==}\StringTok{ }\NormalTok{gen,]}\OperatorTok{$}\NormalTok{frac\_of\_pop), batch\_id)}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}

\CommentTok{\# Trim to final generation}
\NormalTok{df\_infinite\_summary =}\StringTok{ }\NormalTok{df\_infinite\_summary[df\_infinite\_summary}\OperatorTok{$}\NormalTok{generation }\OperatorTok{==}\StringTok{ }\NormalTok{max\_gen,]}
\CommentTok{\# Rename column}
\NormalTok{df\_infinite\_summary}\OperatorTok{$}\NormalTok{restraint\_value =}\StringTok{ }\NormalTok{df\_infinite\_summary}\OperatorTok{$}\NormalTok{mean\_ones }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  res =}\StringTok{ }\KeywordTok{kruskal.test}\NormalTok{(df\_infinite\_summary}\OperatorTok{$}\NormalTok{restraint\_value }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{df\_infinite\_summary}\OperatorTok{$}\NormalTok{mc\_size, df\_infinite\_summary)}
\NormalTok{  df\_kruskal =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{3}\NormalTok{))}
  \KeywordTok{colnames}\NormalTok{(df\_kruskal) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}p\_value\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}chi\_squared\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}df\textquotesingle{}}\NormalTok{)}
\NormalTok{  df\_kruskal[}\KeywordTok{nrow}\NormalTok{(df\_kruskal) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{,] =}\StringTok{ }\KeywordTok{c}\NormalTok{(res}\OperatorTok{$}\NormalTok{p.value, }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{statistic)[}\DecValTok{1}\NormalTok{], }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{parameter)[}\DecValTok{1}\NormalTok{])}
\NormalTok{  df\_kruskal}\OperatorTok{$}\NormalTok{less\_}\FloatTok{0.01}\NormalTok{ =}\StringTok{ }\NormalTok{df\_kruskal}\OperatorTok{$}\NormalTok{p\_value }\OperatorTok{\textless{}}\StringTok{ }\FloatTok{0.01}
...
\begin{Highlighting}[]
\CommentTok{\# Calculate stats}
\NormalTok{df\_infinite\_wilcox =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{5}\NormalTok{))}
\NormalTok{adjacent\_counter =}\StringTok{ }\DecValTok{0}
\KeywordTok{colnames}\NormalTok{(df\_infinite\_wilcox) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}size\_a\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}size\_b\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}p\_value\_corrected\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}p\_value\_raw\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}W\textquotesingle{}}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{(size\_idx\_a }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{(}\KeywordTok{length}\NormalTok{(size\_vec) }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{))\{}
\NormalTok{  size\_a =}\StringTok{ }\NormalTok{size\_vec[size\_idx\_a]}
\NormalTok{  size\_a\_str =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(size\_a, }\StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{, size\_a)}
  \ControlFlowTok{for}\NormalTok{(size\_idx\_b }\ControlFlowTok{in}\NormalTok{ (size\_idx\_a }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{)}\OperatorTok{:}\KeywordTok{length}\NormalTok{(size\_vec))\{}
...
\NormalTok{    size\_b\_str =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(size\_b, }\StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{, size\_b)}
\NormalTok{    res =}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(}
\NormalTok{      df\_infinite\_summary[df\_infinite\_summary}\OperatorTok{$}\NormalTok{mc\_size }\OperatorTok{==}\StringTok{ }\NormalTok{size\_a,]}\OperatorTok{$}\NormalTok{restraint\_value, }
\NormalTok{      df\_infinite\_summary[df\_infinite\_summary}\OperatorTok{$}\NormalTok{mc\_size }\OperatorTok{==}\StringTok{ }\NormalTok{size\_b,]}\OperatorTok{$}\NormalTok{restraint\_value, }
      \DataTypeTok{alternative =} \StringTok{\textquotesingle{}two.sided\textquotesingle{}}\NormalTok{) }
\NormalTok{    df\_infinite\_wilcox[}\KeywordTok{nrow}\NormalTok{(df\_infinite\_wilcox) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{,] =}\StringTok{ }\KeywordTok{c}\NormalTok{(size\_a\_str, size\_b\_str, }\DecValTok{0}\NormalTok{, res}\OperatorTok{$}\NormalTok{p.value, }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{statistic)[}\DecValTok{1}\NormalTok{])}
\NormalTok{  \}}
\NormalTok{\}}
\NormalTok{df\_infinite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected =}\StringTok{ }\KeywordTok{p.adjust}\NormalTok{(df\_infinite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_raw, }\DataTypeTok{method =} \StringTok{\textquotesingle{}holm\textquotesingle{}}\NormalTok{)}
\NormalTok{df\_infinite\_wilcox}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}ns\textquotesingle{}}
\NormalTok{df\_infinite\_wilcox[df\_infinite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected }\OperatorTok{\textless{}=}\StringTok{ }\FloatTok{0.05}\NormalTok{,]}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}*\textquotesingle{}}
\NormalTok{df\_infinite\_wilcox[df\_infinite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected }\OperatorTok{\textless{}=}\StringTok{ }\FloatTok{0.01}\NormalTok{,]}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}**\textquotesingle{}}
\NormalTok{df\_infinite\_wilcox[df\_infinite\_wilcox}\OperatorTok{$}\NormalTok{p\_value\_corrected }\OperatorTok{\textless{}=}\StringTok{ }\FloatTok{0.001}\NormalTok{,]}\OperatorTok{$}\NormalTok{label =}\StringTok{ \textquotesingle{}***\textquotesingle{}}
\KeywordTok{print}\NormalTok{(df\_infinite\_wilcox)}
\end{Highlighting}
\end{Shaded}
