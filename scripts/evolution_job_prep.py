...
scratch_dir = '/mnt/gs18/scratch/users/kgs/cell_gens/'
...
combos.add_val('POP',     [0])
combos.add_val('SAMPLES', [0])
...
for condition_dict in combo_list:        
        ...
        with open(job_dir + filename_prefix + '.sb', 'w') as fp_job:
            ...
            fp_job.write('#SBATCH --job-name cell_gens' + '\n')
