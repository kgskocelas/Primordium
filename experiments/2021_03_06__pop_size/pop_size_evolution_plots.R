...
# Load the data
df = read.csv('evolution/data/scraped_evolution_data_200.csv')
df = rbind(df, read.csv('evolution/data/scraped_evolution_data_2k.csv'))
...
ggsave('./evolution/plots/pop_size_boxplot.png', units = 'in', width = 6, height = 6) 
ggsave('./evolution/plots/pop_size_boxplot.pdf', units = 'in', width = 6, height = 6)
