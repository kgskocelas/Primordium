...
Rscript ${SR_ROOT_DIR}/experiments/scripts/evolution_scrape.R ${SR_EVO_DATA_DIR}/raw_evolution_data_files.txt ${SR_EVO_DATA_DIR}/scraped_evolution_data.csv ${SR_EVO_SCRAPE_GEN_STEP} ${SR_EVO_SCRAPE_GEN_MIN} ${SR_EVO_SCRAPE_GEN_MAX} ${SR_TIMING_SAMPLES_PER_TASK}
