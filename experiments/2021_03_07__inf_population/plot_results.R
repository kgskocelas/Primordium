...
ggplot(df_summary[df_summary$generation <= 10000,], aes(x = generation, y = restraint_value ))  +
  ...
  ggsave('./simulation/plots/simulated_density_over_time_trimmed.png', units = 'in', width = 6, height = 6) +
  ggsave('./simulation/plots/simulated_density_over_time_trimmed.pdf', units = 'in', width = 6, height = 6)
...
ggplot(df_summary[df_summary$generation == 10000,], aes(x = size_factor, y = restraint_value ))  +
  ...
  ggsave('./simulation/plots/evolved_bars.png', units = 'in', width = 3, height = 6) +
  ggsave('./simulation/plots/evolved_bars.pdf', units = 'in', width = 3, height = 6)
